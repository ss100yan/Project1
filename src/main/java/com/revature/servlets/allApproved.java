...
/**
 * Servlet implementation class allApproved
 */
public class allApproved extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session != null) {
			request.getRequestDispatcher("Views/allApproved.html").forward(request, response);
		} else {
